    ...
    public partial class InitMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccidentDetails", x => x.Guid);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsBlockingWay = table.Column<bool>(type: "bit", nullable: false),
                    ResolvedStatus = table.Column<int>(type: "int", nullable: false),
                    Created = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModified = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Accidents", x => x.Guid);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Guid = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CitizenIdentityNumber = table.Column<string>(type: "nvarchar(12)", maxLength: 12, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Guid = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RegistrationCertificateNumber = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AccidentInvolved_Vehicles_VehicleId",
